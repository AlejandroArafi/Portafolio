...
<div className="card-p1 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img className="rounded-t-lg" src="https://res.cloudinary.com/deq2bmgqk/image/upload/v1696047260/portafolio/Captura_de_pantalla_2023-09-30_011404_bewz3q.webp" alt="" />
    </a>
    <div className="p-5">
        <a href="#">
